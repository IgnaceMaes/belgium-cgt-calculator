...
export default class InputsPanel extends Component<InputsPanelSignature> {
  ...
  get isBrokerOptIn() {
    return this.args.brokerReporting === 'opt-in';
  }
  get isBrokerOptOut() {
    return this.args.brokerReporting === 'opt-out';
  }

  <template>
    <section
      class="rounded-2xl border border-border bg-card p-6 backdrop-blur-sm space-y-6"
    >
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-1.5">
            ...
            <Tooltip>
              ...
              <TooltipContent @side="top">Current total market value of your
                investment portfolio</TooltipContent>
            </Tooltip>
          </div>
          <div class="relative">
            <span
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-1.5">
            ...
            <Tooltip>
              ...
              <TooltipContent @side="top">Your portfolio value on 1 January 2026
                — the starting point for calculating taxable gains under Belgian
                law. Gains made before 2026 are tax-free.</TooltipContent>
            </Tooltip>
          </div>
          <div class="relative">
            <span
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-1.5">
            ...
            <Tooltip>
              ...
              <TooltipContent @side="top">Expected average annual return on your
                investments. Historical stock market average is ~7–8%.</TooltipContent>
            </Tooltip>
          </div>
          <div class="relative">
            <Input
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-1.5">
            ...
            <Tooltip>
              ...
              <TooltipContent @side="top">Number of years to project forward.
                All scenarios assume a final sale at the end.</TooltipContent>
            </Tooltip>
          </div>
          <div class="relative">
            <Input
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-1.5">
            ...
            <Tooltip>
              ...
              <TooltipContent @side="top">Capital gains tax rate applied to
                realized gains above the exemption. Belgian law sets this at
                10%.</TooltipContent>
            </Tooltip>
          </div>
          <div class="relative">
      ...
      <div class="space-y-2.5">
        <div class="flex items-center gap-1.5">
          <Label class="text-xs text-muted-foreground">TOB rate (Transaction
            tax)</Label>
          <Tooltip>
            <TooltipTrigger>
              <svg
            ...
            <TooltipContent @side="top" class="max-w-xs">Belgian stock exchange
              tax (Taks op Beursverrichtingen) charged on every buy and sell.
              Most accumulating ETFs pay 1.32%, but some (e.g. registered in
              Belgium or certain EU-domiciled funds) pay only 0.12%.</TooltipContent>
          </Tooltip>
        </div>
      ...
      <div class="space-y-2.5">
        <div class="flex items-center gap-1.5">
          ...
          <Tooltip>
            ...
            <TooltipContent @side="top" class="max-w-xs">With broker
              withholding, your broker deducts CGT only when you actually sell.
              If you hold for years, the tax is deferred — meaning that money
              stays invested and compounds. With self-reporting, you declare and
              pay via your annual tax return.</TooltipContent>
          </Tooltip>
        </div>
        <div class="flex gap-2">
          <button
            ...
            {{on "click" (fn @onBroker "opt-in")}}
          >Broker withholds</button>
          <button
            type="button"
            class="rounded-lg border px-3 py-1.5 text-xs font-medium transition-all duration-200
              {{if
      ...
      <div class="space-y-2.5">
        <div class="flex items-center gap-1.5">
          <Label class="text-xs text-muted-foreground">Portfolio tax
            (effectenrekening)</Label>
          <Tooltip>
            <TooltipTrigger>
              <svg
                class="h-3.5 w-3.5 text-muted-foreground/60 hover:text-muted-foreground transition-colors cursor-help"
            ...
            <TooltipContent @side="top" class="max-w-xs">The taks op
              effectenrekeningen is a 0.15% annual tax on securities accounts
              valued above €1,000,000. It applies to the total account value,
              not just the excess. Assessed on average quarterly reference
        ...
        {{#if @includePortfolioTax}}
          <p class="text-xs text-muted-foreground leading-relaxed">
            0.15% per year on the total account value when it exceeds
            €1,000,000. This is deducted annually from your portfolio, reducing
