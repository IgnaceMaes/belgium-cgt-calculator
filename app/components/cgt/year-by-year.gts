                ...
                <table class="w-full text-xs">
                  <thead>
                    <tr class="border-b border-border bg-muted/50">
                      <th
                        class="px-4 py-2.5 text-left font-medium text-muted-foreground uppercase tracking-wider text-[10px]"
                      >Yr</th>
                      <th
                        class="px-4 py-2.5 text-right font-medium text-muted-foreground uppercase tracking-wider text-[10px]"
                      >Portfolio</th>
                      <th
                        class="px-4 py-2.5 text-right font-medium text-muted-foreground uppercase tracking-wider text-[10px]"
                      >Gain</th>
                  ...
                  <tbody>
                    {{#each section.rows as |row|}}
                      ...
                      >
                        <td
                          class="px-4 py-2 tabular-nums text-muted-foreground"
                        >{{row.year}}</td>
                        <td class="px-4 py-2 text-right tabular-nums">{{this.f
                            row.portfolioValue
                          }}</td>
                        <td class="px-4 py-2 text-right tabular-nums">{{this.f
                            row.realizedGain
                        ...
                        >{{this.f row.netPortfolioAfterTax}}</td>
                      </tr>
                    {{/each}}
                  </tbody>
                </table>
