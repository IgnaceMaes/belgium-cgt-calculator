  ...
  <footer class="rounded-2xl border border-border bg-card px-6 py-5">
    <div class="flex items-start gap-3">
      ...
      <div class="text-xs text-muted-foreground space-y-1 leading-relaxed">
        <p><span class="text-foreground font-medium">Key rules:</span> {{@cgtRatePct}}% CGT on realized gains · €10K/year exempt (unused €1K carries forward, max €5K extra) · losses offset gains within the same year only · TOB on every buy &amp; sell</p>
        <p><span class="text-foreground font-medium">Note:</span> The hold scenario defers all CGT to the final sale. Harvest scenarios pay CGT each year but reset the cost basis, using the exemption annually. Broker opt-in withholds {{@cgtRatePct}}% on all gains upfront; you reclaim the exemption via your tax return ~2 years later. Harvest and smart harvest assume you can rebuy at the same price you sold — in practice, the bid-ask spread and intraday price movement may cause small deviations.</p>
